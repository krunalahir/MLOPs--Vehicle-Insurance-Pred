...
class VehicleData:
    def __init__(self,
        ...
        try:
            ...
            self.Vehicle_Age_lt_1_Years = Vehicle_Age_lt_1_Years
    ...
    def get_vehicle_data_as_dict(self):
        """
        This function returns a dictionary from vehicle data class
        """
        ...
        try:
            input_data = {
                ...
                "Vehicle_Age_lt_1_Years": [self.Vehicle_Age_lt_1_Years],
