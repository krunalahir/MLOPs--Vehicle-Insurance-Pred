...
class DataValidation:
    def __init__(self,data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        """
        :param data_ingestion_artifact: data ingestion output that stored in artifact
        :param data_validation_config:  data validatiion input in config
        """
        try:
    ...
    def validate_number_of_columns(self,dataframe:DataFrame) ->bool:
        ...
        try:
            ...
            logging.info(f"Is required columns present : {self.schema_config['columns']}")
            return status
        except Exception as e:
            raise MyException(e,sys) from e
