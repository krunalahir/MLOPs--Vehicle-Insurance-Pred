...
class DataTransformation:
    ...
    def get_transformer_object(self)->Pipeline:
        """
        Creates and return a data transformer object for the data,
        including gender mapping ,dummy variables creation ,column renaming
        feature scaling,nd type adjustments
        """
        ...
        try:
            ...
            logging.info("Transformation initialized:standardscaler - minmaxscaler")
            ...
            #wraping everything in single pipeline
            final_pipeline=Pipeline(steps=[("preprocessor", preprocessor)])
            logging.info("final pipeline is ready to go")
    ...
    def _rename_columns(self,df):
        ...
        """
        logging.info("Renaming columns and doing the type casting to int")
        df=df.rename(columns={
            "Vehicle_Age_< 1 Year": "Vehicle_Age_lt_1_Years",
    ...
    def _drop_id_columns(self,df):
        """
        Drop the id column if it still exists
        """
        logging.info("dropping id columns if it exists")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        """
        Initiates data transformation component for this pipeline
        """
        try:

            logging.info("Initiating data transformation ,started")
            ...
            logging.info("Input and target columns are loaded for both train and test data")
            ...
            logging.info("Applying Smoothen for handling imbalanced data")
