...
class ModelEvaluation:
    ...
    On Failure  :   Write an exception log and then raise an exception
        ...
        try:
            ...
            logging.info("Test data loaded and now transforming that test data to the prediction")
            ...
            if best_model is not None:
                ...
                logging.info(f"f1_score for production model:{best_model_f1_score} ,f1_score_trained_model:{trained_mode_f1_score}")
